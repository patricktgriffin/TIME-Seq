  ...
  if (sequencing == "PE") {
    writeLines(c("#!/bin/bash", 
                 ...
                 "",
                  ...
                  paste("source ~/python2.7/bin/activate", sep=""),
                  ...
                  paste("ONTARG=$(bedtools intersect -u -a ",i,"_bismark_pe.bam -b /n/data2/hms/genetics/sinclair/Patrick/methylationClock/captureAnalysis/",intFile," | samtools view -c)", sep=""), #intFile must be in directory /n/data2/hms/genetics/sinclair/Patrick/methylationClock/captureAnalysis
                  paste("ONTARGR1=$(bedtools intersect -u -a ",i,"_unmapped_R1.bam -b /n/data2/hms/genetics/sinclair/Patrick/methylationClock/captureAnalysis/",intFile," | samtools view -c)", sep=""), #intFile must be in directory /n/data2/hms/genetics/sinclair/Patrick/methylationClock/captureAnalysis
                  paste("ONTARGR2=$(bedtools intersect -u -a ",i,"_unmapped_R2.bam -b /n/data2/hms/genetics/sinclair/Patrick/methylationClock/captureAnalysis/",intFile," | samtools view -c)", sep=""), #intFile must be in directory /n/data2/hms/genetics/sinclair/Patrick/methylationClock/captureAnalysis
